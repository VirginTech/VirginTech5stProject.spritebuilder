...
- (id)init:(bool)judgFlg
{
    ...
    titleLabel.position=ccp(titleButton.position.x,
                            titleButton.position.y-(titleButton.contentSize.height*titleButton.scale)/2 -5);
    ...
    selectLabel.position=ccp(selectButton.position.x,
                             selectButton.position.y-(selectButton.contentSize.height*selectButton.scale)/2 -5);
    ...
    replayLabel.position=ccp(replayButton.position.x,
                             replayButton.position.y-(replayButton.contentSize.height*replayButton.scale)/2 -5);
    ...
    if(judgFlg)
    {
        ...
        nextLabel.position=ccp(nextButton.position.x,
                               nextButton.position.y-(nextButton.contentSize.height*nextButton.scale)/2 -5);
        ...
        continueLabel.position=ccp(continueButton.position.x,
                        continueButton.position.y-(continueButton.contentSize.height*continueButton.scale)/2 -5);
